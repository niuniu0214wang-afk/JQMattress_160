...
#define AI_MODEL_ORIGIN_MODEL_NAME   "model4"
...
#define AI_MODEL_IN_1_HEIGHT      (26)
#define AI_MODEL_IN_1_WIDTH       (10)
...
#define AI_MODEL_OUT_1_CHANNEL     (1)
#define AI_MODEL_OUT_1_SIZE        (1)
#define AI_MODEL_OUT_1_SIZE_BYTES  (4)
