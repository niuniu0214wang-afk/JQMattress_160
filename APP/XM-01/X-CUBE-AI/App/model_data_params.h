...
#define AI_MODEL_DATA_ACTIVATIONS_SIZES \
  { 16464, }
#define AI_MODEL_DATA_ACTIVATIONS_SIZE     (16464)
#define AI_MODEL_DATA_ACTIVATIONS_COUNT    (1)
#define AI_MODEL_DATA_ACTIVATION_1_SIZE    (16464)



#define AI_MODEL_DATA_WEIGHTS_SIZES \
  { 77364, }
#define AI_MODEL_DATA_WEIGHTS_SIZE         (77364)
#define AI_MODEL_DATA_WEIGHTS_COUNT        (1)
#define AI_MODEL_DATA_WEIGHT_1_SIZE        (77364)
