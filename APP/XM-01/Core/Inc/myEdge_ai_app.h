...
#include "posture_classifier.h"   /* PostureLabel 枚举（含 POSTURE_SITTING）(2026-05-06) */
...
/* 离床状态：1=已离床（无人），0=在床（有人）(2026-05-06) */
extern uint8_t g_bed_exit_0;   /* 下半区离床状态 */
extern uint8_t g_bed_exit_1;   /* 上半区离床状态 */
