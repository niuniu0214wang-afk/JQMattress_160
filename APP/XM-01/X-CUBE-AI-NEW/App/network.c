...
#define AI_NETWORK_MODEL_SIGNATURE     "0x35cc066363fd0338ad5722be89f98315"
...
#define AI_TOOLS_DATE_TIME   "2026-03-03T19:46:26+0800"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 6148, 1, 1),
    6148, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  &conv2d_0_layer, 0x7fab3fe2, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_keras_tensor0_output_array.data = AI_PTR(g_network_activations_map[0] + 1992);
    serving_default_keras_tensor0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 1992);
    ...
    pool_4_output_array.data = AI_PTR(g_network_activations_map[0] + 768);
    pool_4_output_array.data_start = AI_PTR(g_network_activations_map[0] + 768);
    ...
    nl_5_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 64);
    nl_5_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 64);
    ...
    nl_7_output_array.data = AI_PTR(g_network_activations_map[0] + 4);
    nl_7_output_array.data_start = AI_PTR(g_network_activations_map[0] + 4);
    return true;
  }
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_5_bias_array.data = AI_PTR(g_network_weights_map[0] + 6016);
    gemm_5_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 6016);
    gemm_6_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_6_weights_array.data = AI_PTR(g_network_weights_map[0] + 6080);
    gemm_6_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 6080);
    gemm_6_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_6_bias_array.data = AI_PTR(g_network_weights_map[0] + 6144);
    gemm_6_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 6144);
    return true;
  }
