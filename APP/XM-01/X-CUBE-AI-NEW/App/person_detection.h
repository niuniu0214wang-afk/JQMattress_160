/**
  ...
  ******************************************************************************
  */
#ifndef AI_PERSON_DETECTION_H
#define AI_PERSON_DETECTION_H

#include "person_detection_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_PERSON_DETECTION_MODEL_NAME          "person_detection"
#define AI_PERSON_DETECTION_ORIGIN_MODEL_NAME   "person_detection_keras"

/******************************************************************************/
#define AI_PERSON_DETECTION_ACTIVATIONS_ALIGNMENT   (4)
#define AI_PERSON_DETECTION_INPUTS_IN_ACTIVATIONS   (4)
#define AI_PERSON_DETECTION_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_PERSON_DETECTION_IN_NUM        (1)

AI_DEPRECATED
#define AI_PERSON_DETECTION_IN \
  ai_person_detection_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_PERSON_DETECTION_IN_SIZE { \
  AI_PERSON_DETECTION_IN_1_SIZE, \
}
#define AI_PERSON_DETECTION_IN_SIZE_BYTES { \
  AI_PERSON_DETECTION_IN_1_SIZE_BYTES, \
}
#define AI_PERSON_DETECTION_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_PERSON_DETECTION_IN_1_CHANNEL     (40)
#define AI_PERSON_DETECTION_IN_1_SIZE        (40)
#define AI_PERSON_DETECTION_IN_1_SIZE_BYTES  (160)

/******************************************************************************/
#define AI_PERSON_DETECTION_OUT_NUM       (1)

AI_DEPRECATED
#define AI_PERSON_DETECTION_OUT \
  ai_person_detection_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_PERSON_DETECTION_OUT_SIZE { \
  AI_PERSON_DETECTION_OUT_1_SIZE, \
}
#define AI_PERSON_DETECTION_OUT_SIZE_BYTES { \
  AI_PERSON_DETECTION_OUT_1_SIZE_BYTES, \
}
#define AI_PERSON_DETECTION_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_PERSON_DETECTION_OUT_1_CHANNEL     (2)
#define AI_PERSON_DETECTION_OUT_1_SIZE        (2)
#define AI_PERSON_DETECTION_OUT_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_PERSON_DETECTION_N_NODES (8)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup person_detection
 ...
 * @ref ai_person_detection_create. Both the activations memory buffer 
 ...
 * using @ref ai_person_detection_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_person_detection_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_person_detection_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_PERSON_DETECTION_*
 * defines into file @ref person_detection.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_person_detection_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_PERSON_DETECTION_H */
